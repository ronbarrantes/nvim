...
vim.keymap.set("n", "<gc>", ":Commentary<CR>", { noremap = true, silent = true })
vim.keymap.set("v", "<gc>", ":Commentary<CR>", { noremap = true, silent = true })
vim.keymap.set("x", "<gc>", ":Commentary<CR>", { noremap = true, silent = true })
vim.keymap.set("i", "<gc>", "<Esc>:Commentary<CR>i", { noremap = true, silent = true })
